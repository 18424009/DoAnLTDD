...
public class Settings {
    ...
    public static void loadPreferences(Context c){
        ...
        TankSoundManager.setMusicVolume(musicVolume/100.0f);
        TankSoundManager.setSoundVolume(soundVolume/100.0f);
        TankSoundManager.setMusicEnabled(musicEnabled);
        TankSoundManager.setSoundEnabled(soundEnabled);
    ...
    public static Tank getPayer() {
        return tank;
    }

    public static void setPlayer(Tank tank) {
        Settings.tank = tank;
    }
}
